...
const ALL_ROLES = [
  ...
  { value: 'Supplier', label: 'Supplier', color: 'bg-blue-100 text-blue-700' },
  ...
  { value: 'Employee', label: 'Employee', color: 'bg-amber-100 text-amber-700' },
  { value: 'Carting', label: 'Carting', color: 'bg-orange-100 text-orange-700' },
];
      ...
      <div className="md:hidden space-y-4">
        {isLoading ? (
          ...
          parties
            ...
            .map(party => {
              const roles = party.roles || [party.type];
