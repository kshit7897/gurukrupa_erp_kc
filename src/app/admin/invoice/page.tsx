...
import { Eye, Printer, Download, Pencil } from 'lucide-react';
                ...
                {invoices.filter(inv => {
                  ...
                  <tr key={inv.id || inv._id} className="group hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3 flex gap-2 justify-end">
                      <Button size="sm" onClick={() => router.push(`/admin/${inv.type === 'PURCHASE' ? 'purchase' : 'sales'}/create?id=${inv.id || inv._id}`)} icon={Pencil}>Edit</Button>
